      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '3rem 2rem 1.5rem' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '2.5rem', marginBottom: '2.5rem' }}>
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-muted)', fontSize: '0.82rem', lineHeight: 1.7, marginBottom: '1.1rem', maxWidth: '320px' }}>
              AI-powered tutoring and exam preparation for Ethiopian students in Grades 6, 8 and 12.
          ...
          <div>
            ...
            <p style={{ color: 'var(--text-primary)', fontSize: '0.9rem', fontWeight: 700, marginBottom: '0.2rem' }}>
              Adama Smart City
            </p>
            <p style={{ color: 'var(--text-muted)', fontSize: '0.8rem', lineHeight: 1.6, marginBottom: '1rem' }}>
              Adama City Administration<br />
              Digital Innovation and Smart Services Directorate
            </p>
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              <a href="https://adama.gov.et" target="_blank" rel="noopener noreferrer"
                style={{ color: 'var(--text-muted)', fontSize: '0.82rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.4rem' }}
                onMouseEnter={e => (e.currentTarget.style.color = 'var(--primary)')}
                onMouseLeave={e => (e.currentTarget.style.color = 'var(--text-muted)')}>
                <Globe size={13} /> adama.gov.et
              </a>
              <a href="mailto:smartcity@adama.gov.et"
                style={{ color: 'var(--text-muted)', fontSize: '0.82rem', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.4rem' }}
                onMouseEnter={e => (e.currentTarget.style.color = 'var(--primary)')}
                onMouseLeave={e => (e.currentTarget.style.color = 'var(--text-muted)')}>
              ...
              <span style={{ color: 'var(--text-muted)', fontSize: '0.82rem', display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                <MapPin size={13} /> Adama, Oromia, Ethiopia
              </span>
            </div>
          </div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.6rem' }}>
              {legalLinks.map(l => (
                <Link key={l.href} href={l.href}
                  style={{ color: 'var(--text-muted)', fontSize: '0.84rem', textDecoration: 'none', transition: 'color 0.15s ease' }}
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.78rem', lineHeight: 1.6, margin: 0 }}>
            ...
            We never share student data with advertisers. Parents can review or delete their child's data at any time by emailing{' '}
            <a href="mailto:parents@ipass-a.adama.gov.et" style={{ color: 'var(--primary)', textDecoration: 'none' }}>
        ...
        <div style={{
          ...
          <p style={{ color: 'var(--text-muted)', fontSize: '0.77rem', margin: 0 }}>
            {year} I-Pass-A. Developed by <strong style={{ color: 'var(--text-secondary)' }}>Adama Smart City</strong>. All rights reserved.
          </p>
