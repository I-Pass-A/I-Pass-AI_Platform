...
export default function Sidebar() {
  ...
  const navItems = [
    ...
    { name: isAO ? "Qormaata Seennaa" : "Entrance Prep",path: "/entrance",  icon: GraduationCap,   roles: ["student"] },
      ...
      <div style={{ padding: "1.25rem 1.5rem", borderTop: "1px solid var(--glass-border)", display: "flex", flexDirection: "column", gap: "0.875rem" }}>
        <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
          ...
          <div style={{ minWidth: 0 }}>
            <p onClick={() => router.push("/profile")} style={{ fontSize: "0.875rem", fontWeight: 600, color: "var(--primary)", overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap", cursor: "pointer" }}>{user.name} ↗</p>
